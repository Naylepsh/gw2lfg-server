...
export const getItemFrom = (itemFetchers: ItemFetcher[]) => {
...
export const getItem = (fetchItems: ItemsFetcher) => {
...
export const getItemFromEntireAccount = getItemFrom([getItemFromBank]);
